...
export default function ManagerDashboard() {
  ...
  const recentActivity = [
    {
      name: "John Doe",
      action: "Completed Frontend Evaluation",
      time: "2 hours ago",
      status: "Passed",
    },
    {
    ...
    {
      name: "Mike Johnson",
      action: "Completed Backend Evaluation",
      time: "1 day ago",
      status: "Failed",
    },
    {
      name: "Emma Wilson",
      action: "Completed Full Stack Evaluation",
      time: "2 days ago",
      status: "Passed",
    },
  ];
    ...
    <div className="space-y-8 py-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Welcome back! Here&apos;s an overview of your team&apos;s evaluation
          performance.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat, idx) => (
          <Card
            key={idx}
            className="overflow-hidden border-border/50 bg-gradient-to-br from-card to-card/50"
          >
            ...
            <CardContent className="space-y-2">
              ...
              {stat.trend && (
                <div
                  className={`text-xs font-medium flex items-center gap-1 ${stat.trend.isPositive ? "text-emerald-500" : "text-amber-500"}`}
                >
