...
export default function EvaluationDetailPage({
  ...
  return str.split('').reverse().join('');
      ...
      score: 95,
      feedback:
        "Excellent solution! Correct approach and handles edge cases well.",
    },
  ];
  ...
  const aiInterviewFeedback = {
    communication: {
      score: 8,
      feedback:
        "Clear and articulate communication. Good structure in responses.",
    },
    technical: {
      score: 8.5,
      feedback:
        "Strong technical knowledge. Demonstrated deep understanding of frontend concepts.",
    },
    problem_solving: {
      score: 7.5,
      feedback:
        "Good approach to problem solving. Could have explored more edge cases.",
    },
    overall: {
      score: 8,
      feedback:
        "Overall excellent performance. Shows great potential as a senior developer.",
    },
  };
    ...
    <div className="space-y-6 py-8">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div className="flex-1">
          ...
          <p className="text-muted-foreground">
            {evaluationData.employeeName} - {evaluationData.evaluationTitle}
          </p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
            ...
            <div>
              ...
              <p className="text-sm font-semibold">
                {new Date(evaluationData.completedDate).toLocaleDateString()}
              </p>
            </div>
          </div>
        </CardContent>
        ...
        <TabsContent value="answers" className="space-y-6">
          ...
          <Card className="border-border/50">
            <CardHeader>
              ...
              <CardDescription>
                Answered 3 out of 3 questions correctly
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              {mcqAnswers.map((answer) => (
                <div
                  key={answer.id}
                  className="space-y-3 pb-4 border-b border-border/30 last:pb-0 last:border-0"
                >
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-emerald-600 dark:text-emerald-500 mt-1">
                      Excellent MCQ performance with perfect score. Strong
                      coding fundamentals demonstrated in the challenge.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-600 dark:text-amber-500 mt-1">
                      Consider improving communication and explanation of
                      approach. Some minor efficiency improvements possible in
                      code.
                    </p>
                  </div>
                </div>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between pb-3">
                ...
                <span className="text-3xl font-bold">
                  {aiInterviewFeedback.overall.score}/10
                </span>
              </div>
              <div className="w-full h-3 bg-muted rounded-full overflow-hidden">
                <div
                  className="h-full bg-primary"
                  style={{
                    width: `${(aiInterviewFeedback.overall.score / 10) * 100}%`,
                  }}
                />
              </div>
              <p className="text-sm text-muted-foreground pt-2">
                {aiInterviewFeedback.overall.feedback}
              </p>
            </CardContent>
          </Card>
        </TabsContent>
      ...
      <Card className="border-border/50 bg-muted/30">
        <CardHeader>
          ...
          <CardDescription>
            Approve or reject this evaluation result
          </CardDescription>
        </CardHeader>
        <CardContent>
          {approvalStatus === null ? (
            ...
            <div className="flex items-center gap-3 p-4 bg-red-500/20 rounded-md border border-red-500/30">
              ...
              <p className="text-red-700 dark:text-red-400 font-medium">
                Result rejected. Feedback has been sent to the candidate.
              </p>
            </div>
          )}
        </CardContent>
